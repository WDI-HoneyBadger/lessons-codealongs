...
class CupsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create cup" do
    assert_difference('Cup.count') do
      post cups_url, params: { cup: { capacity: @cup.capacity, color: @cup.color, material: @cup.material } }
    end
  ...
  test "should update cup" do
    patch cup_url(@cup), params: { cup: { capacity: @cup.capacity, color: @cup.color, material: @cup.material } }
